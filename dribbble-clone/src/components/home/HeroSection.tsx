    ...
    return (
        <div className='flex flex-col items-center justify-center pt-16'>
            ...
            <div className='pb-28 pt-28 mt-28 w-full bg-yellowbg'>
                <div className='mx-32 flex flex-col gap-10 justify-center items-center '>
                    <p className='text-6xl font-serif text-center font-normal w-[50%]'>Find your next designer today</p>
                    ...
                    <p className='text-xl m-4'>Are you a designer? <span className='hover:cursor-pointer underline'>Join Dribbble</span></p>
                </div>
            </div>
